...
const PROTECTED = ["/dashboard", "/crm", "/horas", "/auditoria", "/perfil", "/tickets", "/proyectos", "/usuarios"];
...
export const config = { matcher: ["/dashboard/:path*", "/crm/:path*", "/horas/:path*", "/auditoria/:path*", "/perfil/:path*", "/tickets/:path*", "/tickets", "/proyectos/:path*", "/usuarios/:path*"] };
